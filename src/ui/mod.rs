...
pub fn create_app_ui(wgpu_ctx: &mut WgpuCtx, layout_context: &mut layout::LayoutContext) {
    ...
    let fill_background_id = BackgroundBuilder::with_color(BackgroundColorConfig {
        color: Color::Bisque,
    })
    .with_debug_name("Fill Background")
    .with_z_index(-1)
    .with_fixed_position(Anchor::Center)
    .build(
        &mut layout_context.world,
    ...
    .with_debug_name("Background Color")
    .with_size(200, 200)
    .with_border_radius(BorderRadius::all(50.0))
    .with_shadow(Color::Black, (0.0, 0.0), 2.0, 0.5)
    .with_animation(AnimationConfig {
        duration: Duration::from_millis(200),
        easing: EasingFunction::EaseOutExpo,
        direction: AnimationDirection::Alternate,
    ...
    let test_text_id = TextBuilder::new()
        .with_debug_name("Test Text")
        .with_size(85, 20)
    ...
    .with_border_radius(BorderRadius::all(50.0))
    .with_fixed_position(Anchor::Center)
    .with_shadow(Color::Black, (0.0, 0.0), 20.0, 0.2)
    .with_z_index(1)
    .with_animation(AnimationConfig {
        duration: Duration::from_millis(200),
        easing: EasingFunction::EaseOutExpo,
    ...
    // Add background color as a child of main container
    layout_context
        .world
        .add_child_to_parent(main_container_id, background_color_id);
    layout_context
        .world
        .add_child_to_parent(main_container_id, test_text_id);
    layout_context
        .world
